...
public class OkHttpHelper {
    ...
    public SoapObject postSoap(String url, String method, String[] array, String header, String spaceName, String[] headers){
        ...
        try {
            ...
            return new SoapObject().xmlPull(response.body().string(),method);
        } catch (IOException e) {
            e.printStackTrace();
