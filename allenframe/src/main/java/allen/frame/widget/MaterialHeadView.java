...
public class MaterialHeadView extends FrameLayout implements
		MaterialHeadListener {
	...
	protected void onAttachedToWindow() {
		...
		LayoutParams layoutParams = new LayoutParams(
				MaterialUtil.dip2px(getContext(), progressSize),
				MaterialUtil.dip2px(getContext(), progressSize));
	...
	@Override
	public void onPull(MaterialRefreshLayout materialRefreshLayout,
			float fraction) {
		if (materialWaveView != null) {
		...
		if (circleProgressBar != null) {
			...
			float a = MaterialUtil.limitValue(1, fraction);
	...
	@Override
	public void onRelease(MaterialRefreshLayout materialRefreshLayout,
			float fraction) {
