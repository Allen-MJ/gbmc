...
public class MaterialRefreshLayout extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defstyleAttr) {
        ...
        refreshStyle = t.getInt(R.styleable.MaterialRefreshLayout_refresh_style, 0);
        if (waveType == 0) {
    ...
    protected void onAttachedToWindow() {
        ...
        setWaveHeight(MaterialUtil.dip2px(context, waveHeight));
        setHeaderHeight(MaterialUtil.dip2px(context, headHeight));
        if(refreshStyle==0){
            mMaterialHeaderView = new MaterialHeaderView(context);
            LayoutParams layoutParams = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, MaterialUtil.dip2px(context, hIGHER_HEAD_HEIGHT));
        ...
        LayoutParams layoutParams2 = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, MaterialUtil.dip2px(context, hIGHER_HEAD_HEIGHT));
