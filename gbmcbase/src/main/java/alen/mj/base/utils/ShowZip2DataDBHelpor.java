 ...
 *
 */
public class ShowZip2DataDBHelpor implements Serializable {
...
//	private String srcPath = sdcard_path + "/Download/XML20171127141145.zip";
	...
	private ZipFileReaderAnalysisHelpor zipHelpor;
	
	public ShowZip2DataDBHelpor(Context context){
		 this.context = context;
		 zipHelpor = new ZipFileReaderAnalysisHelpor();
	}
        ...
        if(isOK){
            ...
            if(mgwyinfo == null){
            	...
            	if(mgwyinfo.getNodeMap().get(gwyinfo.TYPE).equals(gwyinfo.TABNORMALLAB)){
            		...
            		// 处理M01  采用方案二时，必须先处理这个
//           		 	List<MCSubEntry> listM01 = zipHelpor.doM01AnalysisEvent(
//           				 zipHelpor.getReadFilePath(destPath + "Table/", "M01"));
